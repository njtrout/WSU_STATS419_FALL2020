...
Xs.self
Xs.self = scale(Xs.self);
Xs.self = as.data.frame(Xs.self);
Xs.self
...
Xs.self.bartlett = cortest.bartlett(Xs.self, n = nrow(Xs.self));

str(Xs.self.bartlett);
...
```{r }
# pick a maximum number to examine
maxFactors = 30;  # I have 60 variables
