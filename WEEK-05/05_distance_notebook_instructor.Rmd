...
result.neighbors
result.neighbors$distance = conv_unit(distm(result.neighbors[,3:2], fun=distHaversine),  "m", "mi");

result.neighbors$distance <= 10;

result.neighbors$zipcode = result.neighbors$zipcode!="99163"
