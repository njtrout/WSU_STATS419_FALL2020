...
\CommentTok{\#change to github path}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myData =}\StringTok{ }\KeywordTok{as.matrix}\NormalTok{(nba.df[,}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{)]);}
\NormalTok{file.correlation =}\StringTok{ }\KeywordTok{paste0}\NormalTok{(path.tables,}\StringTok{"nba{-}correlation{-}table.tex"}\NormalTok{);}

\KeywordTok{buildLatexCorrelationTable}\NormalTok{(myData, }
  \DataTypeTok{rotateTable =} \OtherTok{FALSE}\NormalTok{,}
  \DataTypeTok{width.table =} \FloatTok{.90}\NormalTok{,}
  \DataTypeTok{myFile =}\NormalTok{ file.correlation,}
  \DataTypeTok{myNames =} \KeywordTok{c}\NormalTok{(}\StringTok{"height"}\NormalTok{, }\StringTok{"wingspan"}\NormalTok{, }\StringTok{"standing.reach"}\NormalTok{, }\StringTok{"hand.length"}\NormalTok{, }\StringTok{"hand.width"}\NormalTok{),}
  \DataTypeTok{myCaption =} \StringTok{"Descriptive Statistics and Correlation Analysis (NBA)"}\NormalTok{,}
  \DataTypeTok{myLabel=} \StringTok{"table:correlation{-}nba"}\NormalTok{);}
...
\NormalTok{myData =}\StringTok{ }\KeywordTok{as.matrix}\NormalTok{(measure.df[,}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{)]);}
\NormalTok{file.correlation =}\StringTok{ }\KeywordTok{paste0}\NormalTok{(path.tables,}\StringTok{"measure{-}students{-}correlation{-}table.tex"}\NormalTok{);}
...
\KeywordTok{buildLatexCorrelationTable}\NormalTok{(myData, }
  ...
  \DataTypeTok{myFile =}\NormalTok{ file.correlation,}
  \DataTypeTok{myNames =} \KeywordTok{c}\NormalTok{(}\StringTok{"height"}\NormalTok{, }\StringTok{"wingspan"}\NormalTok{, }\StringTok{"standing.reach"}\NormalTok{, }\StringTok{"hand.length"}\NormalTok{, }\StringTok{"hand.width"}\NormalTok{),}
  \DataTypeTok{myCaption =} \StringTok{"Descriptive Statistics and Correlation Analysis (MEASURE)"}\NormalTok{,}
  \DataTypeTok{myLabel=} \StringTok{"table:correlation{-}student{-}measure"}\NormalTok{);}
